...
import './payAdjustmentTable.css'

function PayAdjustmentTable() {
    return (
                ...
                <div className="travelquotetable_feild  w-100 mx-4 p-2">
                    <div className='sec des'>
                        <div className='head d-flex align-items-center justify-content-between'>
                            <div><label> All Pay Adjustments </label></div>
                                ...
                                <Table responsive>
                                    <thead>
                                        <tr className='bg-light'>
                                            ...
                                            <th>Branch</th>
                                            <th>Registrant</th>
                                            <th>Name <sub>2</sub> <i className='fa-solid fa-caret-up px-2'></i> </th>
                                            <th>Type</th>
                                            <th>Method</th>
                                            <th>Hrs</th>
                                            <th>+/-</th>
...
export default PayAdjustmentTable