...
import './batchCheckProccessingTable.css'

function BatchCheckProccessingTable() {
    return (
                ...
                <div className="travelquotetable_feild  w-100 mx-4 p-2">
                    <div className='sec des'>
                        <div className='head d-flex align-items-center justify-content-between'>
                            <div><label> All Batches </label></div>
                                ...
                                <Table responsive>
                                    <thead>
                                        <tr className='bg-light'>
                                            ...
                                            <th>Batch ID <sub>1</sub> <i className='fa-solid fa-caret-up px-2'></i> </th>
                                            <th>Status</th>
                                            <th>Paid Leave</th>
                                            <th>Mode</th>
                                            <th>Check Type</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td>Consolidated</td>
                                            <td className='text-uppercase'>EFT</td>
                                            <td></td>
                                            <td>3</td>
                                            <td>08/05/22</td>
                                            <td>E000000062-E000000065</td>
                                            <td>1545.57</td>
                                            <td>
                                                <div >
...
export default BatchCheckProccessingTable