...
import './payAdjustmentAccrualsTable.css'

function PayAdjustmentAccrualsTable() {
    return (
                ...
                <div className="travelquotetable_feild  w-100 mx-4 p-2">
                    <div className='sec des'>
                        <div className='head d-flex align-items-center justify-content-between'>
                            <div><label> Pay Adjustment Accruals </label></div>
                                ...
                                <Table responsive>
                                    <thead>
                                        <tr className='bg-light'>
                                            ...
                                            <th>Description <sub>2</sub> <i className='fa-solid fa-caret-up px-2'></i> </th>
                                            <th>Amount</th>
                                            {/* <th>Action</th> */}
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Completed</td>
                                            <td>08/05/22</td>
                                            <td className='text-uppercase'>Redstoned Healthy birmingham</td>
                                            <td>Jenkins,Alexandra</td>
                                            <td className='w-75 text-wrap'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</td>
                                            <td>0.00</td>
                                            {/* <td>
                                                <div >
                                            ...
                                            <td className='text-uppercase'>Redstoned Healthy birmingham</td>
                                            <td>Jenkins,Alexandra</td>
                                            <td className='w-75 text-wrap'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.when an unknown printer took a galley of type and scrambled it to make a type specimen book</td>
                                            <td>0.00</td>
                                            {/* <td>
                                                <div >
                                                    <i className="fa-solid fa-print" style={{ color: 'orange', padding: '3px' }}></i>
...
export default PayAdjustmentAccrualsTable