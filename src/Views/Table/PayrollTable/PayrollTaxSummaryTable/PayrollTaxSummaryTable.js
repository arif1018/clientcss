...
import './payrollTaxSummaryTable.css'

function PayrollTaxSummaryTable() {
    return (
                ...
                <div className="travelquotetable_feild  w-100 mx-4 p-2">
                    <div className='sec des'>
                        <div className='head d-flex align-items-center justify-content-between'>
                            <div><label> Payroll Tax Summary </label></div>
                                ...
                                <Table responsive>
                                    <thead>
                                        <tr className='bg-light'>
                                            ...
                                            <th>Description</th>
                                            <th>Employee Tax</th>
                                            <th>YTD Gross Wages</th>
                                            <th>YTD Basis Wages</th>
                                            <th>YTD Tax Wages</th>
                                            <th>YTD Tax Amount</th>
                                            {/* <th>Action</th> */}
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>08-22878564</td>
                                            <td className='text-uppercase'>FD</td>
                                            <td className='text-uppercase'>MED12</td>
                                            <td>00-00-9-9089765-Res</td>
...
export default PayrollTaxSummaryTable