...
import './eFTExportTable.css'

function EFTExportTable() {
    return (
                ...
                <div className="travelquotetable_feild  w-100 mx-4 p-2">
                    <div className='sec des'>
                        <div className='head d-flex align-items-center justify-content-between'>
                            <div><label> EFT Export </label></div>
                                ...
                                <Table responsive>
                                    <thead>
                                        <tr className='bg-light'>
                                            <th className='w-25'>ExportID <sub>1</sub> <i className='fa-solid fa-caret-down px-2'></i> </th>
                                            <th className='w-25'>User</th>
                                            <th className='w-50'>Export Time</th>
