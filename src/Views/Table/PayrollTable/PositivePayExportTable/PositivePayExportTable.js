...
import './positivePayExportTable.css'

function PositivePayExportTable() {
    return (
                ...
                <div className="travelquotetable_feild  w-100 mx-4 p-2">
                    <div className='sec des'>
                        <div className='head d-flex align-items-center justify-content-between'>
                            <div><label> Positive Pay Export </label></div>
                                ...
                                <Table responsive>
                                    <thead>
                                        <tr className='bg-light'>
                                            <th>ExportID <sub>1</sub> <i className='fa-solid fa-caret-down ps-2'></i></th>
                                            <th>User</th>
                                            <th>Export Time</th>
                                            <th>Action</th>
...
export default PositivePayExportTable