...
import './cashApplicationJournalTable.css'

function CashApplicationJournalTable() {
    return (
                ...
                <div className="travelquotetable_feild  w-100 mx-4 p-2">
                    <div className='sec des'>
                        <div className='head d-flex align-items-center justify-content-between'>
                            <div><label> Cash Application Journal </label></div>
                                ...
                                <Table responsive>
                                    <thead>
                                        <tr className='bg-light'>
                                            <th>ID <sub>1</sub> <i className='fa-solid fa-caret-up ps-2'></i></th>
                                            <th>Status</th>
                                            <th>Type</th>
                                            <th>Branch</th>
                                            <th>Check Count</th>
                                            <th className="text-end">Batch Total</th>
                                            <th>Action</th>
...
export default CashApplicationJournalTable