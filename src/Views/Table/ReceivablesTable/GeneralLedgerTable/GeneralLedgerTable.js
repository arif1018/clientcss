...
import './generalLedgerTable.css'

function GeneralLedgerTableReceivable() {
    return (
                ...
                <div className="travelquotetable_feild  w-100 mx-4 p-2">
                    <div className='sec des'>
                        <div className='head d-flex align-items-center justify-content-between'>
                            <div><label> Unexported GL Postings </label></div>
...
export default GeneralLedgerTableReceivable