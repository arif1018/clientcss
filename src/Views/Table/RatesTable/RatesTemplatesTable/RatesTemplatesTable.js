...
import './ratesTemplatesTable.css'

function RatesTemplatesTable() {
    return (
                ...
                <div className="ratestable_feild  w-100 mx-4 p-2">
                    <div className='sec des'>
                        <div className='head d-flex align-items-center justify-content-between'>
                            <div><label>All Rate Templates</label></div>
                                ...
                                <Table responsive>
                                    <thead>
                                        <tr className='bg-light'>
                                            <th className="w-100">Template Name</th>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <div className="div__registryTable justify-content-start gap-2">
        ...
        <Navbar expand="lg" className="navbar navv">
            <Container fluid className="mx-3">
                <Nav
                    ...
                    navbarScroll
                >
                    <Nav.Link href="/rateTemplate" className='py-1 px-3'><i className="fa-solid fa-square-plus"></i>  New </Nav.Link>
...
export default RatesTemplatesTable