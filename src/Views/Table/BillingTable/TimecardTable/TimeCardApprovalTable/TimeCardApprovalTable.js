...
import './timeCardApproval.css'

function TimeCardApprovalTable() {
    return (
                ...
                <div className="travelquotetable_feild  w-100 mx-4 p-2">
                    <div className='sec des'>
                        <div className='head d-flex align-items-center justify-content-between'>
                            <div><label> TimeCard Approval </label></div>
                                ...
                                <Table responsive>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>08/05/22 Tu</td>
                                            <td>1[H]7:30A-5P(30)</td>
                                            <td><Form.Select className='border-0 py-0'>
                                                <option>R C</option>
                                                </Form.Select></td>
                                            <td>9.00</td>
                                            <td>14.00</td>
