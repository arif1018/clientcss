                                        ...
                                        <Form.Group className=" tab_form_" controlId="formBasicText">
                                            ...
                                            <div className='inner_ d-flex border-bottom'>
                                                ...
                                                <div className='py-1 px-2 left w-75 overtime'>
                                                    <Form.Check type="radio" name="type" className="p-0 d-flex align-items-center" label="Daily Order" />
                                                    <Form.Check type="radio" name="type" className="p-0 d-flex align-items-center" label="Contract" />
                                                    <Form.Check type="radio" name="type" className="p-0 d-flex align-items-center" label="Client Contract Template" />
                                                </div>
                                            </div>
